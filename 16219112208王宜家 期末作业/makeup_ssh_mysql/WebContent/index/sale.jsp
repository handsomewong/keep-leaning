...
<div class="center_content">
	...
	<div class="left_content">
		...
		<div class="title"><span class="title_icon"><img src="img/bullet1.png"/></span>优惠促销</div>
     	...
     	<c:forEach var="makeup" items="${saleList}">
			...
			<div class="feat_prod_box">
				...
				<div class="prod_det_box"><span class="special_icon"><img src="img/promo_icon.png"/></span>
