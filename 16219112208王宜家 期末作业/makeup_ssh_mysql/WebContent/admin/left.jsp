...
.meun_img{float:left;width:7px;height:27px;background:url(img/menu_1.gif) no-repeat;}
...
function show_menu_box(num){
	if($('box'+num)){   
		if($('box'+num).style.display=='none'){
			...
			$('img'+num).style.background='url(img/menu_2.gif)';
		}else {
			$('box'+num).style.display='none';
			$('img'+num).style.background='url(img/menu_1.gif)';
		}
	}
}
  ...
  <tr>
    <td width="169" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td height="20" background="img/main_11.png">&nbsp;</td>
		  </tr>
		  <tr>
			<td>
				<div class="meun_div" align="center">
					...
					<div class="meun_box none_box" id="box3">
						<ul>
							<li><a href="makeupList.action"  target="rightFrame">&middot;商品列表</a></li>
							<li><a href="makeupList.action?status=1"  target="rightFrame">&middot;推荐列表</a></li>
							<li><a href="makeupList.action?status=2"  target="rightFrame">&middot;最新列表</a></li>
							<li><a href="makeupList.action?status=3"  target="rightFrame">&middot;促销列表</a></li>
							<li><a href="makeupAd.action"  target="rightFrame">&middot;添加商品</a></li>
						</ul>
					</div>
