...
<body>
	...
	<form action="makeupAdd.action" method="post" enctype="multipart/form-data">

		图片：<input type="file" name="photo" size="12" required="required"/><br>
		商品名：<input type="text" name="makeup.name" required="required"/><br>
		价格：<input type="text" name="makeup.price" required="required"/><br>
		介绍：<input type="text" name="makeup.intro" required="required"/><br>
		品牌：<input type="text" name="makeup.press"/><br>
		出品日期：<input type="text" id="datepicker" name="makeup.pubdate"/><br>
